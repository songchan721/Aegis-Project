...
class TestDatabaseIntegration:
    ...
    async def test_database_repository_integration(self, db_manager):
        ...
        async with manager.session() as session:
            repo = BaseRepository(session, TestUser)
...
class TestLoggingIntegration:
    ...
    def test_logging_with_auth_context(self, mock_stdout):
...
class TestMessagingIntegration:
    ...
    def messaging_components(self):
        ...
        with patch('aegis_shared.messaging.subscriber.AIOKafkaConsumer', return_value=mock_kafka_consumer):
...
class TestCacheIntegration:
    ...
    async def test_cache_decorator_integration(self, cache_client, mock_redis):
        ...
        cache_key = cache_client._generate_cache_key("expensive_operation", ("a", "b"), {})
        ...
        # Function should not be called again if cache hit works
        # (In real scenario with working Redis)
...
"""
    ...
    def test_configuration_loading_integration(self, config_setup):
        ...
        try:
            ...
            assert config_loader.get("JWT_SECRET_KEY") == "test-secret-key"
            assert config_loader.get("SERVICE_PORT") == "8080"
            assert config_loader.get("service.name") == "integration-test"
...
class TestSchemaRegistryIntegration:
    ...
    def schema_registry_setup(self, temp_dir):
        ...
        policies_schema = {
            ...
            "references": [
                {"schema": "users", "column": "id", "on_delete": "CASCADE"}
            ]
        }
