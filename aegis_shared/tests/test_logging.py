...
from aegis_shared.logging.handlers import (
...
class TestStructuredLogging:
    ...
    def test_log_levels(self, mock_stdout):
        ...
        test_logs = [line for line in lines if "message" in line and "Logging initialized" not in line]
    ...
    def test_exception_logging(self, mock_stdout):
        ...
        # Note: The exception info might be in exc_info or similar field depending on formatter
