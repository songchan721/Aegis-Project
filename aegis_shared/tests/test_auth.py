...
from aegis_shared.auth.rbac import Permission, RBACManager, Role
...
class TestJWTHandler:
    ...
    def test_create_token_with_custom_expiry(self, jwt_handler, sample_user_payload):
        ...
        token = jwt_handler.create_access_token(
            sample_user_payload, expires_delta=expires_delta
        )
...
class TestAuthMiddleware:
    ...
    async def test_middleware_with_valid_token(
        self, auth_middleware, sample_user_payload
    ):
...
class TestRBACManager:
    ...
    def test_create_permission(self, rbac_manager):
        ...
        permission = Permission(name="read_policy", resource="policy", action="read")
    ...
    def test_create_role(self, rbac_manager):
        ...
        role = Role(name="policy_manager", permissions=permissions)
    ...
    def test_check_permission_success(self, rbac_manager):
        ...
        permissions = [Permission("read_policy", "policy", "read")]
        ...
        result = rbac_manager.check_permission(
            user_roles=user_roles, required_permission="read_policy"
        )
    ...
    def test_check_permission_failure(self, rbac_manager):
        ...
        result = rbac_manager.check_permission(
            user_roles=user_roles, required_permission="write_policy"
        )
...
class TestServiceAccount:
    ...
    def test_service_account_verification(self, sample_jwt_secret):
        ...
        service_data = {"service_name": "user-service", "permissions": ["read_user"]}
