...
from aegis_shared.messaging.schemas import EventSchema, EventMetadata
...
class TestKafkaProducer:
    ...
    def kafka_producer(self, mock_aiokafka_producer):
        ...
        with patch('aegis_shared.messaging.producer.AIOKafkaProducer', return_value=mock_aiokafka_producer):
    ...
    @pytest.mark.asyncio
    async def test_send_message_error_handling(self, kafka_producer, mock_aiokafka_producer):
...
class TestEventPublisher:
    ...
    @pytest.mark.asyncio
    async def test_publish_event_with_metadata(self, event_publisher, mock_kafka_producer):
