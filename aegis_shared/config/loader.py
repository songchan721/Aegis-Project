...
class Settings(BaseSettings):
    ...
    kafka_consumer_group_id: str = Field(default="aegis-consumer", validation_alias="KAFKA_CONSUMER_GROUP_ID")
    kafka_auto_offset_reset: str = Field(default="latest", validation_alias="KAFKA_AUTO_OFFSET_RESET")
    ...
    api_rate_window: int = Field(default=900, validation_alias="API_RATE_WINDOW")  # 15분

    # 외부 서비스 설정
    external_service_timeout: int = Field(default=30, validation_alias="EXTERNAL_SERVICE_TIMEOUT")
    external_service_retries: int = Field(default=3, validation_alias="EXTERNAL_SERVICE_RETRIES")
